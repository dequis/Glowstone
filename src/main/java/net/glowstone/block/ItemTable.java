...
public final class ItemTable {
    ...
    private void registerBuiltins() {
        ...
        reg(Material.NETHER_FENCE, new BlockDirectDrops(ToolType.PICKAXE));
        ...
        reg(Material.STONE, new BlockDirectDrops(Material.COBBLESTONE, ToolType.PICKAXE));
        ...
        reg(Material.GOLD_PLATE, new BlockDirectDrops(ToolType.PICKAXE));
        reg(Material.IRON_PLATE, new BlockDirectDrops(ToolType.PICKAXE));
        reg(Material.STONE_PLATE, new BlockDirectDrops(ToolType.PICKAXE));
